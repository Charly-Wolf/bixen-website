  ...
  const caseStudies = [
    {
      ...
      link: "https://www.linkedin.com/pulse/c%2525C3%2525B3mo-intuitivo-construye-las-bases-del-futuro-de-la-experiencia-7uljf/?trackingId=CsCafy1XSwK4KVM7CfIxYg%3D%3D",
    },
    {
    ...
    <div className="container px-4 md:px-6 py-16" id="case-studies">
      ...
      {showABInBevDetails && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#004953] rounded-[1.5rem] max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 md:p-8 relative">
              <button
                className="absolute top-4 right-4 text-white hover:bg-white/10 rounded-full p-2 bg-black/20 z-10"
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <div className="mb-8">
                    <h3 className="text-[#01F9C6] text-lg mb-2">CASE STUDY 2025</h3>
                    <h2 className="text-3xl font-bold text-white mb-4">
                      UY - Optimization of the barley drying process in production plant
                    </h2>

                    <div className="mb-8">
                      <h3 className="text-[#01F9C6] text-lg mb-2">THE COMPANY</h3>
                    ...
                    <div className="mb-8">
                      <h3 className="text-[#01F9C6] text-lg mb-2">THE CHALLENGE</h3>
                      <p className="text-white/90">
                    ...
                    <div className="mb-8">
                      <h3 className="text-[#01F9C6] text-lg mb-2">EXPECTED BENEFITS</h3>
                      <ul className="text-white/90 list-disc pl-5 space-y-2">
                    ...
                    <div className="mb-8">
                      <h3 className="text-[#01F9C6] text-lg mb-2">TECHNOLOGY</h3>
                      <ul className="text-white/90 list-disc pl-5 space-y-2">
                ...
                <div className="flex flex-col justify-between">
                  <div className="bg-white rounded-xl overflow-hidden p-8 flex items-center justify-center">
                    <Image
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-yhR4SR5hnlCjbhOcXVdmY6jj7udXYS.png"
                      alt="ABInBev logo"
                      width={400}
