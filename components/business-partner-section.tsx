...
export default function BusinessPartnerSection() {
  ...
  return (
    <div className="container px-4 md:px-6 py-16" id="business-partners">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {industries.map((industry, index) => (
              <div
                key={index}
                className={`${industry.bgColor} border ${industry.borderColor} rounded-xl p-4 flex flex-col items-center justify-center text-center hover:bg-opacity-30 transition-all duration-200`}
              >
